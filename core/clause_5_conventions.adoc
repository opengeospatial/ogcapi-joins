...
The link relation types that are used in this document are listed in <<link-relations-table,Table 1>>.
...
[[link_schema]]
The individual hyperlink elements that make up a "links" elements are defined in the http://beta.schemas.opengis.net/ogcapi/common/part1/0.1/core/openapi/schemas/link.json[hyperlink schema], originally defined in the section 6.3 of the <<ogcapi-common-part1, OGC API - Common - Part 1 specification>>.

include::requirements/core/schemas/link_schema.adoc[]
