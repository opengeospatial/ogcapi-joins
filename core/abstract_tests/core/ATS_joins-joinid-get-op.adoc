...
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/core/joins-joinid-get-op*
...
. Validate the contents of the returned document using test <<ats_core_joins-joinid-get-success, /ats/core/joins-joinid-get-success>>.
