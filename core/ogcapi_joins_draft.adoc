:Title: OGC API - Joins - Part 1: Core
:titletext: OGC API - Joins - Part 1: Core
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/xx/xx
|Internal reference number of this OGC(R) document:    YY-xxx
|Version: link:http://docs.opengeospatial.org/DRAFTS/YY-xxx.html[1.0.0-SNAPSHOT (Editor's draft)]
