...
. If the server implementation supports the __data joining operations__ operation set, validate the support by using tests in the conformance classes <<ats_data_joining, Data Joining>> and <<ats_join_delete, Join Delete>>.
