[[ats_data_joining_collections-collectionid-keys-keyfieldid-op]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/data-joining/collections-collectionid-keys-keyfield-op*
...
. Validate the contents of the returned document using test: <<ats_data_joining_collections-collectionid-keys-keyfieldid-success, /ats/data-joining/collections-collectionid-keys-keyfieldid-success>>.
|===