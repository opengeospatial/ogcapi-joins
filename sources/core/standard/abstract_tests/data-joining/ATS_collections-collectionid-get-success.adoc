...
. Validate that any extent properties included in the Collection document complies with test <<ats_data_joining_collections-collectionid-get-success-extent,/conf/data-joining/collections-collectionid-get-success-extent>>.
...
. Validate the content of the Collection document for all supported media types using the <<collections_collectionid_schema, collectionDesc Schema>> and test <<ats_json-json-content, /conf/json/json-content>>.
