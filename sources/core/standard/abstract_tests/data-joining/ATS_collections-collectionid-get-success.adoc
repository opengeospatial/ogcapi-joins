...
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/data-joining/collections-collectionid-get-success*
...
^|Test Method | 
. Validate the structure and content of the response document using <<ats_data_joining_collections-collectionid-get-success-content, /ats/data-joining/collections-collectionid-get-success-content>>.
