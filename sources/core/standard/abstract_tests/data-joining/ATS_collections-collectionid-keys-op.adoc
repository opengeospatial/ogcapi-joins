[[ats_data_joining_collections-collectionid-keys-op]]
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/data-joining/collections-collectionid-keys-op*
...
. Validate the contents of the returned document using test <<ats_data_joining_collections-collectionid-keys-success, /ats/data-joining/collections-collectionid-keys-success>>
|===