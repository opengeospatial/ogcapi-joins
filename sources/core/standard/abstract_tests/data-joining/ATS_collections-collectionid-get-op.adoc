...
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/data-joining/collections-collectionid-get-op*
...
. Validate the contents of the returned document using test <<ats_data_joining_collections-collectionid-get-success, /ats/data-joining/collections-collectionid-get-success>>.
|===