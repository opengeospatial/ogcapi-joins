...
. Validate that the response document complies with test <<ats_data_joining_joins-joinid-get-success-links-collection, /conf/data-joining/joins-joinid-get-success-links-collection>>
