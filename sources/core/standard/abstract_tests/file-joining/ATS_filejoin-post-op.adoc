...
[width="90%",cols="2,6a"]
|===
^|*Abstract Test {counter:ats-id}* |*/ats/file-joining/filejoin-post-op*
...
3. Validate the contents of the returned document using test <<ats_file_joining_filejoin-post-success, /ats/file_joining/filejoin-post-success>>
