...
include::abstract_tests/core/ATS_collections-get-success-links.adoc[]

include::abstract_tests/core/ATS_collections-get-success-timestamp.adoc[]

include::abstract_tests/core/ATS_collections-get-success-items.adoc[]
...
include::abstract_tests/core/ATS_collections-collectionid-get-success-content.adoc[]

include::abstract_tests/core/ATS_collections-collectionid-rc-md-extent.adoc[]

include::abstract_tests/core/ATS_collections-collectionid-rc-md-items-links.adoc[]
...
include::abstract_tests/core/ATS_collections-collectionid-keys-default-key.adoc[]

include::abstract_tests/core/ATS_collections-collectionid-keys-links.adoc[]

include::abstract_tests/core/ATS_collections-collectionid-keys-items-links.adoc[]
...
include::abstract_tests/data-joining/ATS_data-joining-query.adoc[]

include::abstract_tests/data-joining/ATS_data-joining-succees.adoc[]
...
include::abstract_tests/file-joining/ATS_file-joining-query.adoc[]

include::abstract_tests/file-joining/ATS_file-joining-success.adoc[]
