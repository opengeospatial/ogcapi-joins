...
The <<core-overview-table,Table 4>> contains an overview of the operations specified in the core module.
...
include::./requirements/core/REQ_joins-joinid-post-success-attribute-data-file-csv-attribute-names.adoc[]
