...
part:: If the server implements __data joining operations__, it SHALL support the HTTP GET operation at the path `{root}/collections/{collectionId}/keys/{keyFieldId}`.
