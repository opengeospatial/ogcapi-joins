...
part:: The server SHALL support the GeoJSON format for the left dataset.
...
part:: The server SHALL support the CSV format for the right dataset.
part:: The input data files SHALL be encoded with the `UTF-8` encoding.
part:: The Form Data parameters of the query are listed in a <<req_file_joining_filejoin-post-op-form-data-parameters,Table 6>>:
====